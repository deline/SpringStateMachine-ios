...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        fiftyCentButton.rac_signalForControlEvents(UIControlEvents.TouchUpInside).subscribeNext { _ in
            print("******* HEY ******")
        }

        oneDollarButton.rac_signalForControlEvents(UIControlEvents.TouchUpInside).subscribeNext { _ in
    ...
    private func executeCoinEnteredCommand() -> RACCommand {
        return RACCommand(signalBlock: { _ -> RACSignal! in
